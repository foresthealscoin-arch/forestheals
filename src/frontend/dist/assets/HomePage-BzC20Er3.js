import { c as createLucideIcon, j as jsxRuntimeExports, r as reactExports, m as motion, B as Badge, L as Link, a as Button, S as ShoppingBag, b as Shield, H as Heart, A as AnimatePresence, u as useActor, I as Input, d as useCartStore, e as ue, f as createActor } from "./index-CfU2kVIJ.js";
import { S as Skeleton } from "./skeleton-Dbe_tSkr.js";
import { u as useFeaturedProducts } from "./useProducts-B7nbWxOB.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
        ...
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 sm:gap-6", children: Array.from({ length: 8 }, (_, i) => `skel-${i}`).map((k) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "bg-card rounded-xl overflow-hidden shadow-sm",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-40 w-full" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 sm:p-4 space-y-2", children: [
          ...
          k
        )) }) : displayProducts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "text-center py-16 text-muted-foreground",
            "data-ocid": "best_sellers.empty_state",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "Products are loading. Please check back shortly." })
          }
                ...
                "img",
                {
                  ...
                  onError: (e) => {
                    ...
                    if (parent) {
                      ...
                      placeholder.className = "w-full h-full bg-primary/10 flex items-center justify-center";
                      placeholder.innerHTML = '<span class="text-primary/30 text-xs font-semibold">Forestheals</span>';
    ...
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-44 sm:h-52 bg-gradient-to-br from-muted to-secondary/10 flex items-center justify-center overflow-hidden", children: [
          bundle.images.map((src, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 sm:p-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-5", children: bundle.tagline }),
