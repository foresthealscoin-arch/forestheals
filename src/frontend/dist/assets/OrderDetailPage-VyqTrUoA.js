import { i as useParams, j as jsxRuntimeExports, q as PageSpinner, a as Button, L as Link, B as Badge, m as motion, P as PRODUCTS_SEED_DATA, M as MessageCircle } from "./index-C77TdgT2.js";
import { b as useOrder } from "./useOrders-Cjye9Wxd.js";
import { c as formatDateTime, b as getOrderStatusColor, f as formatPrice, a as formatDate } from "./formatters-C5vW1ZnJ.js";
import { P as Package } from "./package-B8cYcbks.js";
import { C as ChevronRight } from "./chevron-right-ZsOnTFmP.js";
import { A as ArrowLeft } from "./arrow-left-BBaMQphy.js";
import { C as Clock } from "./clock-By9zywF1.js";
import { T as Truck } from "./truck-BeFEKH0R.js";
import { C as CircleCheck } from "./circle-check-CaxxOUrS.js";
import { D as Download } from "./download-CkGLiiSo.js";
import { C as Circle } from "./circle-DAtIlNZH.js";
import "./backend-CD8IXjU0.js";
import "./useMutation-DqmtgTe2.js";
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-0", children: order.items.map((item, i) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl overflow-hidden shrink-0 bg-muted", children: product ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "img",
                      {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2.5 text-sm", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Badge,
                        {
                          className: order.paymentMethod === "cod" && order.status !== "delivered" ? "bg-secondary text-secondary-foreground" : "bg-primary/10 text-primary",
                          children: order.paymentMethod === "cod" && order.status !== "delivered" ? "Pay on Delivery" : "Paid"
                        }
                      )
                    ] }),
