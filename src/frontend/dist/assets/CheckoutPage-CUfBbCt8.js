import { c as createLucideIcon, k as useAuthStore, r as reactExports, l as redirect, j as jsxRuntimeExports, P as PRODUCTS_SEED_DATA, a as Button, L as Link, A as AnimatePresence, m as motion, I as Input, B as Badge } from "./index-Oxc-_oxi.js";
import { L as Label } from "./label-5KV58XeA.js";
import { S as Separator } from "./separator-DH-3to-o.js";
import { u as useCart } from "./useCart-CFy8Ts2_.js";
import { u as useCreateOrder } from "./useOrders-BU3bpvql.js";
import { f as formatPrice, a as formatDate } from "./formatters-C5vW1ZnJ.js";
...
import { A as ArrowLeft } from "./arrow-left-D2qSI3bk.js";
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2.5 mb-4", children: [
                order.items.slice(0, 3).map((item) => {
                  ...
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-lg overflow-hidden bg-muted shrink-0", children: product && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "img",
                      {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 text-xs text-muted-foreground bg-muted/40 rounded-lg px-3 py-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "GST invoice will be available in your dashboard for download." })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "my-3" }),
...
function CheckoutPage() {
  ...
  if (placedOrder !== null) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(SuccessScreen, { order: placedOrder, cartItems: PRODUCTS_SEED_DATA });
  }
  if (items.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 max-h-48 overflow-y-auto scrollbar-hide", children: items.map((item, i) => {
                      ...
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-lg overflow-hidden bg-muted shrink-0", children: product && /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "img",
                              {
                                src: product.imageUrl,
                                alt: product.name,
