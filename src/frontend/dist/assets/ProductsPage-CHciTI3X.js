import { c as createLucideIcon, e as create, f as useNavigate, r as reactExports, j as jsxRuntimeExports, m as motion, B as Badge, g as Search, I as Input, X, a as Button, A as AnimatePresence } from "./index-C77TdgT2.js";
...
import { a as useProductCategories, b as useProducts } from "./useProducts-BS7BNAOh.js";
...
function SkeletonGrid() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-4 gap-4", children: Array.from({ length: 12 }, (_, i) => `skeleton-${i}`).map((key) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
